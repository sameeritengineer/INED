                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <textarea id="summary-ckeditor" rows="5" class="form-control" name="l_description" placeholder="Short Description">{{ $boards->l_description }}</textarea>
                              </div>
                           </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <textarea id="summary-ckeditor1" rows="5" class="form-control" name="meta_description" placeholder="Meta Description">{{ $boards->meta_description }}</textarea>
                              </div>
                           </div>
                        </div>
                     </div>
