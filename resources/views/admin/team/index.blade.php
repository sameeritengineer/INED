                    ...
                    <table class="table table-striped table-bordered zero-configuration">
                      ...
                      <tbody>
                        ...
                        <tr>                  
                          ...
                          <td>{{$team->location}}</td>            
                          <td>
                          	<a class="btn btn-outline-warning" href="{{ route('team.edit',$team->id) }}">Edit</a>
                          </td>
                          <td><button type="button" class="btn btn-outline-warning" onclick="deleteteam({{$team->id}},'{{$team->name}}')"><i class="fa fa-trash"></i></button></td> 
