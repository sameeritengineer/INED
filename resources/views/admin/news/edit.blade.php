                        ...
                        <div class="row">
                           <div class="col-md-4">
                              <div class="form-group">
                                 ...
                                 <div class="controls">
                                    <input type="text" id="contentinput1" required data-validation-required-message="This field is required" class="form-control" placeholder="Name" name="name" value="{{ $news->name }}">
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-3">
                              <div class="form-group">
                              	...
                              	<div class="controls">
                                 <input type="text" id="contentinput2" required data-validation-required-message="This field is required" class="form-control" placeholder="Slug" name="slug" value="{{ $news->name }}">
                                </div>
                              </div>
                           </div>
                           <div class="col-md-3">
                           ...
                           <div class="col-md-2">
                              <div class="form-group">
                                ...
                                <div class="controls">
                                 ...
                                 <input type="checkbox" name="upcoming" id="custom7" value="{{$news->upcoming}}" {{$news->upcoming==1?'checked':''}}> <label for="custom7">Upcoming</label>
                                </div>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <textarea id="summary-ckeditor" rows="5" class="form-control editor" name="description" placeholder="Description">{{ $news->description }}</textarea>
                              </div>
                           </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                           <div class="col-md-12">
                              <div class="form-group">
                                 ...
                                 <textarea id="summary-ckeditor1" rows="5" class="form-control editor" name="meta_description" placeholder="Meta Description">{{ $news->meta_description }}</textarea>
                              </div>
                           </div>
                        </div>
                     </div>
