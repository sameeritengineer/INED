                        ...
                        <div class="row">
                           <div class="col-md-3">
                              <div class="form-group">
                                 ...
                                 <div class="controls">
                                    <input type="text" id="projectinput1" required data-validation-required-message="This field is required" class="form-control" placeholder="Category Name" name="cat_name" value="{{ $category->name }}">
                                 </div>
                              </div>
                           </div>
                           <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <div class="controls">
                                 <input type="text" id="projectinput2" required data-validation-required-message="This field is required" class="form-control" placeholder="Category Slug" name="cat_slug" value="{{ $category->slug }}">
                                </div>
                              </div>
                           </div>
                           <div class="col-md-3">
