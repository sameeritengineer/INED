                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="form-group">
                                 ...
                                 <input type="text" id="summary-ckeditor" class="form-control" placeholder="Description" name="description" value="{{ $banners->description }}">
                              </div>
                           </div>
                          <div class="col-md-3">
                              <div class="form-group">
                                 <label for="font_size">Font Size in pixel</label>
                                <input type="text" id="font_size" class="form-control" placeholder="Font Size Example: 20px" name="font_size" value="{{ $banners->font_size }}">
                              </div>
                           </div>
                           ...
                           <div class="col-md-3">
                              <div class="form-group">
                                ...
                                <input type="text" id="color" class="form-control" placeholder="Color Example: #ffff" name="color" value="{{ $banners->color }}">
                              </div>
                           </div>
