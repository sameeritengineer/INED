  ...
  <div class="content-wrapper data">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-xs-12 mb-2">
        	<h3 class="content-header-title mb-0">Our banner</h3>
    	</div>  
                    ...
                    <table class="table table-striped table-bordered zero-configuration">
                      ...
                      <tbody>
                        ...
                        <tr>                  
                          ...
                          <td>
                          	<a class="btn btn-outline-warning" href="{{ route('banner.edit',$banner->id) }}">Edit</a>
                          </td>
                          <td><button type="button" class="btn btn-outline-warning" onclick="deletebanner({{$banner->id}},'{{$banner->name}}')"><i class="fa fa-trash"></i></button></td> 
...
<div class="modal fade text-xs-left" id="deleteForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="{{ route('banner.destroy',1) }}" id="deletebannerForm" method="POST" novalidate>
        @method('DELETE')
        @csrf
        <div class="modal-body">
          <h4>Are you sure want to delete this Banner <span id="text"></span>?</h4>
        </div>
...
function deletebanner(id,name)
{
  ...
  $('#deletebannerForm').attr('action', url);
